...
public class PaymentDTO extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1249003932858167889L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PaymentDTO\",\"namespace\":\"com.example.dto\",\"fields\":[{\"name\":\"description\",\"type\":\"string\"},{\"name\":\"status\",\"type\":\"string\"}]}");
   ...
   */
  public PaymentDTO(java.lang.CharSequence description, java.lang.CharSequence status) {
   ...
   */
  public static com.example.dto.PaymentDTO.Builder newBuilder() {
    return new com.example.dto.PaymentDTO.Builder();
  }
   ...
   * @return A new PaymentDTO RecordBuilder
   */
  public static com.example.dto.PaymentDTO.Builder newBuilder(com.example.dto.PaymentDTO.Builder other) {
    return new com.example.dto.PaymentDTO.Builder(other);
  }
   ...
   * @return A new PaymentDTO RecordBuilder
   */
  public static com.example.dto.PaymentDTO.Builder newBuilder(com.example.dto.PaymentDTO other) {
    return new com.example.dto.PaymentDTO.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentDTO>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.dto.PaymentDTO.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.dto.PaymentDTO other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.description)) {
        this.description = data().deepCopy(fields()[0].schema(), other.description);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.dto.PaymentDTO.Builder setDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.dto.PaymentDTO.Builder clearDescription() {
      description = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.dto.PaymentDTO.Builder setStatus(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.dto.PaymentDTO.Builder clearStatus() {
      status = null;
